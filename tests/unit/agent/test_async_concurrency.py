...
# ── C-5: Source inspection — no blocking sleep ────────────────────────────────


class TestNoBlockingSleep:
    def test_time_not_imported_in_retriever(self) -> None:
    ...
    def test_tenacity_retry_used_in_retriever(self) -> None:
    ...
    def test_time_not_imported_in_executor(self) -> None:
    ...
    def test_tenacity_retry_used_in_executor(self) -> None:
...
# ── C-6: Source inspection — ainvoke / no run_in_executor ────────────────────


class TestOrchestratorSourceInspection:
    def test_run_uses_ainvoke(self) -> None:
    ...
    def test_callback_uses_ainvoke(self) -> None:
    ...
    def test_run_uses_locked_not_wait_for(self) -> None:
    ...
    def test_callback_uses_locked_not_wait_for(self) -> None:
